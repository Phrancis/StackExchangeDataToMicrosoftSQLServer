...
IF EXISTS (
    ...
    AND SPECIFIC_NAME = 'usp_LoadPostsXml'
)
DROP PROCEDURE RawDataXml.usp_LoadPostsXml;
GO

CREATE PROCEDURE RawDataXml.usp_LoadPostsXml
...
BEGIN
    ...
    *****/
    ...
    This section parses the loaded XML document into columns and puts those in CleanData.Posts table.
    ...
    *****/
    ...
    SELECT 
        ...
        ClosedDate,
        CommunityOwnedDate
    FROM OPENXML(@Doc, 'posts/row')
    WITH (
        Id INT '@Id',
        PostTypeId TINYINT '@PostTypeId',
        ...
        LastEditDate DATETIME2 '@LastEditDate',
        LastActivityDate DATETIME2 '@LastActivityDate',
        Title NVARCHAR(250) '@Title',
        Tags NVARCHAR(250) '@Tags',
        AnswerCount INT '@AnswerCount',
        CommentCount INT '@CommentCount',
        FavoriteCount INT '@FavoriteCount',
        ClosedDate DATETIME2 '@ClosedDate',
        CommunityOwnedDate DATETIME2 '@CommunityOwnedDate'
    );
