...
IF EXISTS (
    ...
    AND SPECIFIC_NAME = 'usp_LoadTagsXml'
)
DROP PROCEDURE RawDataXml.usp_LoadTagsXml;
GO

CREATE PROCEDURE RawDataXml.usp_LoadTagsXml
...
BEGIN
    ...
    *****/
    ...
    This section parses the loaded XML document into columns and puts those in CleanData.Tags table.
    ...
    *****/
    ...
    SELECT 
        ...
        ExcerptPostId,
        WikiPostId
    FROM OPENXML(@Doc, 'tags/row')
    WITH (
        Id INT '@Id',
        TagName NVARCHAR(256) '@TagName',
        [Count] INT '@Count',
        ExcerptPostId INT '@ExcerptPostId',
        WikiPostId INT '@WikiPostId'
    );
