...
IF EXISTS (
    ...
    AND SPECIFIC_NAME = 'usp_LoadPostHistoryXml'
)
DROP PROCEDURE RawDataXml.usp_LoadPostHistoryXml;
GO

CREATE PROCEDURE RawDataXml.usp_LoadPostHistoryXml
...
BEGIN
    ...
    *****/
    ...
    This section parses the loaded XML document into columns and puts those in CleanData.PostHistory table.
    ...
    *****/
    ...
    INSERT INTO CleanData.PostHistory (
        SiteId,
        ApiSiteParameter,
        RowId,
        PostHistoryTypeId,
    ...
    WITH (
        ...
        PostId INT '@PostId',
        RevisionGUID UNIQUEIDENTIFIER '@RevisionGUID',
    ...
    IF @ReturnRows = 1
    BEGIN
        SELECT * FROM CleanData.PostHistory
        WHERE SiteId = @SiteId
