...
IF EXISTS (
    ...
    AND SPECIFIC_NAME = 'usp_LoadCommentsXml'
)
DROP PROCEDURE RawDataXml.usp_LoadCommentsXml;
GO

CREATE PROCEDURE RawDataXml.usp_LoadCommentsXml
...
BEGIN
    ...
    *****/
    ...
    This section parses the loaded XML document into columns and puts those in CleanData.Comments table.
    ...
    *****/
    ...
    INSERT INTO CleanData.Comments (
        SiteId,
        ApiSiteParameter,
        RowId,
        PostId,
    ...
    IF @ReturnRows = 1
    BEGIN
        SELECT * FROM CleanData.Comments
        WHERE SiteId = @SiteId
